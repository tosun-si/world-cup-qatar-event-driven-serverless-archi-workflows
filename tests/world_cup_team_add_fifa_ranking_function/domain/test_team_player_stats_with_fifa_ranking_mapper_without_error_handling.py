...
class TestTeamPlayerStatsWithFifaRankingMapperWithoutErrorHandling:

    def test_given_input_teams_player_stats_when_map_to_stats_domain_with_fifa_ranking_then_expected_result_no_error_handling(
            self):
